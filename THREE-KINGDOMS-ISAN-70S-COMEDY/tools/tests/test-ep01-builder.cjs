...
async function main(){
 ...
 console.log('PASS: source preserved, exact assets and style, native project shape, 6 scenes/36s/one location, speaker refs, continuity, stale-media removal, rejection gates, STEP5 parity and ZIP CRC checks. Real P&P import and visual generation are NOT tested.');
}
